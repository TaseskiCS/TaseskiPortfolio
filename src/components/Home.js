...
import Carousel from './Skills/Carousel/Carousel.js'
...
export default function Home () {
    ...
    return (
        ...
        <div className="flex flex-col mb-40 md:h-full md:mt-20">
            <div className="bg-dark-500 flex w-full flex-col md:flex-row gap-5 items-center justify-center text-white relative">
                ...
                <div className='md:w-3/6' data-aos="fade-right" data-aos-duration="1000" data-aos-offset="100" >
                    <div className="flex flex-col w-full mt-8">
                        ...
                        <h1 className="name mb-3 text-3xl font-bold">Antonio Taseski</h1>
            ...
            <div class="mt-20 flex flex-col bounce arrow-bounce ">
                    <h1>↓ ↓</h1>
            </div>
        </div>
        </>
